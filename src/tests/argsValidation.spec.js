...
describe("checkFileExists", () => {
  it('should throw FileMissingError if input doesnt exist',  () => {
    process.argv.push('node', 'my_ciphering_cli', ...INPUT_WITH_UNEXISTING_FILE.split(" "));
  ...
  it('should correctly encode anf decode data (exp)',  () => {
    process.argv.push('node', 'my_ciphering_cli', ...OUTPUT_WITH_UNEXISTING_FILE.split(" "));
...
describe("validateArgCount", () => {
  it("should return true if any arg is duplicated", () => {
    process.argv.push('node', 'my_ciphering_cli', ...DUPLICATED_ARGS.split(" "));
