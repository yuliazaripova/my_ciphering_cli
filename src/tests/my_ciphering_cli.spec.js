...
describe("my_ciphering_cli error scenarios", () => {
  it("should show error if input file doesn't exist", (done) => {
    ...
    cp.stderr.on("data", function (data) {
      expect(data.toString().trim()).toEqual(
        "Error: \"Файл input.txt недоступен\""
      );
      done();
    });
  });
  it("should show error if output file doesn't exist", (done) => {
    ...
    cp.stderr.on("data", function (data) {
      expect(data.toString().trim()).toEqual(
        "Error: \"Файл output.txt недоступен\""
      );
      done();
    });
  });
  it("should show error if arg for config is missed", (done) => {
    ...
    cp.stderr.on("data", function (data) {
      expect(data.toString().trim()).toEqual(
        "Error: \"Проверьте правильность ввода. Аргумент config отсутствует\""
      );
      done();
    });
  });
  it("should show error if any args are duplicated", (done) => {
    ...
    cp.stderr.on("data", function (data) {
      expect(data.toString().trim()).toEqual(
        "Error: \"Проверьте правильность ввода. Аргументы дублируются\""
      );
      done();
    });
  });
  it("should show error if config is not valid", (done) => {
    ...
    cp.stderr.on("data", function (data) {
      expect(data.toString().trim()).toEqual(
        "Error: \"Проверьте правильность ввода. Аргумент config невалиден\""
      );
      done();
    });
  });
